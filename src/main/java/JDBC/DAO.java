...
public class DAO {
    ...
    public List<String> getAllActiveLoan(Connection connection) throws SQLException, IOException, ClassNotFoundException {
        ...
        while(rs.next()){
            ...
            if ((lObj.loanStatus.toString()).equalsIgnoreCase("ACTIVE")){
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException, IOException {
        ...
        c2.customerId = String.valueOf(102);
        ...
        la2.loanStatus =LoanStatus.CLOSED;
        ...
        la3.loanStatus =LoanStatus.CLOSED;
